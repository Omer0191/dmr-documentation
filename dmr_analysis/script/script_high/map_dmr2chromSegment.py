    ...
    for fil in in_files:
        ...
        for ti in uq_type_in_df:
            ...
            out_file = os.path.join(out_folder,
                                    os.path.basename(fil_name) + '_min' + str(min_length) + '_' + ti + '.bed.gz')
            print(out_file)
...
if __name__ == '__main__':
    ...
    top_percent = 0.91
    isSmooth = 0
    in_sorted_dmr_file = in_dmr_folder + '24_chroms_high_miniPercentChange_gt_0.0001_Pcutoff_0.05_isSmooth_' + str(
        isSmooth) \
