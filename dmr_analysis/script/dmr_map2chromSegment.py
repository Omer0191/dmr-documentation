...
def main2(in_files,out_folder,column_name,in_sorted_dmr_file, dmr_min_cutoff, min_overlap):
...
def main(type_names, out_file_string,out_file_names,min_length,out_folder,column_name,in_sorted_dmr_file, dmr_min_cutoff, min_overlap):
...
def run(args):
  ...
  if is_combined_chromatinSegment_exist==0:
    ...
    main(type_names, out_file_string,out_file_names,min_length,out_folder,column_name,in_sorted_dmr_file, dmr_min_cutoff, min_overlap)
  else:
    ...
    main2(in_files,out_folder,column_name,in_sorted_dmr_file, dmr_min_cutoff, min_overlap)
