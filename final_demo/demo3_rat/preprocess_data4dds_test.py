...
os.system('bedtools2.2 intersect -a ' + full_mr_file + ' -b ' + enhancer_file + \
                  ' -v > ' + out_file)
out_file2mr_not_in_enhancer_tss=out_file.replace('.bed','_tss.bed')
os.system('bedtools2.2 intersect -a ' + out_file + ' -b ' + tss_file + \
...
cmd2='bedtools2.2 intersect -a '+ out_file3 + \
